...
class TestBookModel(TestCase):
    ...
    def test_create_transaction(self):
        ...
        transaction = Transaction(
            book_id=retrieved_book.id, member_id=1, type=TransactionType.ISSUE
        )
    ...
    def test_create_member(self):
        ...
        member = Member(name="John Doe", debt=20, books_borrowed=3)
    ...
    def test_default_attributes(self):
        ...
        retrieved_book = Book.query.filter_by(title="Another test book").first()
    ...
    def test_book_transaction_relationship(self):
        ...
        book = Book(title="Test and DSA", author="John Doe", quantity=4, penalty_fee=20)

        db.session.add(book)
        db.session.commit()

        retrieved_book = Book.query.filter_by(title="Test and DSA").first()

        transaction1 = Transaction(
            book_id=retrieved_book.id, member_id=2, type=TransactionType.ISSUE
        )
    ...
    def test_member_transaction_relationship(self):
        ...
        transaction1 = Transaction(
            book_id=1, member_id=retrieved_member.id, type=TransactionType.ISSUE
        )

        transaction2 = Transaction(
            book_id=2, member_id=retrieved_member.id, type=TransactionType.ISSUE
        )
